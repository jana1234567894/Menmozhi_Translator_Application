...
export default function Dashboard() {
    ...
    const [meetingData, setMeetingData] = useState<{ id: string, password: string, meetingUri?: string } | null>(null);
    ...
    const handleCreateMeeting = async () => {
        console.log('🚀 ===== CREATE MEETING (Google Meet) STARTED =====');
        ...
        try {
            ...
            if (!response.ok) {
                ...
                if (errorData.needsAuth) {
                    ...
                    const authUrl = `${import.meta.env.VITE_SERVER_URL}${errorData.authUrl}`;
            ...
            const { meetingId, password, meetingUri } = data;
            console.log('🎫 Meeting ID:', meetingId);
            console.log('🔐 Password:', password);
            console.log('🔗 Google Meet URI:', meetingUri);

            setMeetingData({ id: meetingId, password, meetingUri });
    ...
    const joinCreatedMeeting = () => {
        ...
        if (meetingData.meetingUri) {
            ...
            alert('Meeting URI not available');
        }
    };
